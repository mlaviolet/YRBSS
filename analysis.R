...
begin_lst <- list(c(2, 3, 23, 76, 84, 87), 
                  ...
                  c(2, 3, 53, 358, 370, 375), 
                  c(2, 3, 59, 358, 370, 375), 
                  c(2, 3, 59, 363, 376, 373), 
                  c(2, 3, 60, 364, 374, 377))
end_lst <- list(c(2, 3, 23, 83, 86, 91), 
                ...
                c(2, 3, 53, 369, 374, 378), 
                c(2, 3, 59, 369, 374, 378), 
                c(2, 3, 59, 372, 382, 373),
                c(2, 3, 60, 373, 376, 382))
